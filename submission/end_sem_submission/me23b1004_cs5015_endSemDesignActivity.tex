...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{interaction_direct_manipulation.png}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{symptom_browse_section.png}}
    ...
    \hfill
    \begin{subfigure}[b]{0.47\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{symptom_browse_results.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{visual_design_home.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{visual_design_doctor_profile.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{persuasion_scarcity.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{persuasion_commitment.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{persuasion_authority.png}}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.47\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{color_psychology_1.png}}
        \caption{Amber slots signal ``Filling up fast'' (urgency/caution).}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.47\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{color_psychology_2.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{user_support_quickref.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{help_emergency.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{navigation_breadcrumb.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{navigation_skip_link.png}}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.47\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{web_usability_404.png}}
    ...
    \hfill
    \begin{subfigure}[b]{0.47\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{web_usability_chatbot_open.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.6\textwidth]{keyboard_shortcuts_modal.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.8\textwidth]{universal_design_tolerance_error.png}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{otp_login.png}}
        \caption{Phone login mode with country code selector.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{otp_login_sms_1.png}}
        \caption{Validation error on invalid phone format.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{otp_login_sms_2.png}}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.47\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{captcha_login.png}}
        \caption{Unverified CAPTCHA. The ``Sign In'' button is locked. \textit{Block K.}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.47\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{captcha_solved.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.6\textwidth]{enhanced_v4_onboarding4.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.8\textwidth]{user_support_quickref.png}}
...
\begin{itemize}[leftmargin=1.5em]
  \item \textbf{Live Demo:} \url{https://hci-design-hackathon.vercel.app/}
...
\newpage
\part*{Appendix: Mid-Semester Submission}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{practo_footer.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{our_footer_b.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{practo_homepage.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{our_home_b.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{practo_search_results.png}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.85\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{our_search_results_b.png}}
        \caption{Collapsed --- essentials only}
    \end{subfigure}
    
    \vspace{1.5em}
    \begin{subfigure}[b]{0.85\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{our_expanded_card_b.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.85\textwidth]{our_onboarding_1_b.png}}
    \caption{Better Practo --- Onboarding Step 1: Find Trusted Doctors}
\end{figure}

\vspace{1em}
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.85\textwidth]{our_onboarding_2_b.png}}
    \caption{Better Practo --- Onboarding Step 2: Book Instantly}
\end{figure}

\vspace{1em}
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.85\textwidth]{our_onboarding_3_b.png}}
    \caption{Better Practo --- Onboarding Step 3: Get Care, Your Way}
\end{figure}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.85\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{practo_booking_slots.png}}
        \caption{Slot selection --- no progress bar}
    \end{subfigure}
    
    \vspace{1.5em}
    \begin{subfigure}[b]{0.85\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{practo_booking.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=\textwidth]{our_booking_main_b.png}}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.85\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{our_booking_step2_b.png}}
        \caption{Step 2 --- Details input}
    \end{subfigure}
    
    \vspace{1.5em}
    \begin{subfigure}[b]{0.85\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{our_booking_step3_b.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.8\textwidth]{practo_help.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.8\textwidth]{our_help_b.png}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{practo_nav_1.png}}
        \caption{Login page --- no active nav indicator}
    \end{subfigure}
    
    \vspace{1.5em}
    \begin{subfigure}[b]{\textwidth}
        \imgborder{\includegraphics[width=\textwidth]{practo_nav_2.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.75\textwidth]{our_navbar_active_1_b.png}}
    \caption*{(a) Home page active}
    
    \vspace{0.4em}
    \imgborder{\includegraphics[width=0.75\textwidth]{our_navbar_active_2_b.png}}
    \caption*{(b) Find Doctors page active}
    
    \vspace{0.4em}
    \imgborder{\includegraphics[width=0.75\textwidth]{our_navbar_active_3_b.png}}
    \caption*{(c) Help page active}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.8\textwidth]{practo_password.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.9\textwidth]{our_login_b.png}}
...
\begin{figure}[H]
    \centering
    \imgborder{\includegraphics[width=0.6\textwidth]{practo_city_selection.png}}
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Live Demo}: \url{https://hci-design-hackathon.vercel.app/}
    \item \textbf{Source Code}: \url{https://github.com/R-Abinav/hci-design-hackathon}
