...
\begin{figure}[H]
    ...
    \caption{The Login page featuring the ``I'm not a robot'' reCAPTCHA v2 widget. The ``Sign In'' button is locked until verification is complete. The simulated UI provides a loading spinner during evaluation and a green checkmark upon success. \textit{Block K.}}
\end{figure}
